...
class Manager//Бывший класс Sorter. Основной управляющий класс программы, хранящий все методы сортировки и т.п., 
                //а так же контейнеры данных о "контейнерах" и "фабриках" и проч.(пароль)
{
private:
    ...
    string password;
    //Возможно позже добавлю set индексов, но пока для этого нет нужды
